...
import getMenuTagsQuery from '../../apollo/schemas/getMenuTagsQuery.graphql';
...
export const GET_MENU_TAGS = getMenuTagsQuery;
    ...
    <ul className={classes.ul}>
      <li className={classes.li}>
        <Typography variant="button" component="p" className={classes.header}>
          <LinkTo hoverNone href="/blog/tags">
            Tags
          </LinkTo>
        </Typography>
      </li>
...
export default withStyles(styles)(MenuTags);
